...
@SuppressWarnings({"DuplicateExpressions", "AccessStaticViaInstance", "NonAtomicOperationOnVolatileField"})
public final class VolatileTest {
    ...
    public void should_1() throws InterruptedException {
        ...
        System.out.println(DecimalFormatFactory.defaultInteger().format(atomicVar.intValue()));
        assertEquals(iterationQuantity * 2, atomicVar.intValue());
    }
